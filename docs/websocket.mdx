...
Emitted after deferred final transcription replaces realtime rows. The payload is a refresh notification, not a segment bundle. Clients should fetch the transcript again through the REST API.
...
```
2025-10-04T14:50:35.101823 - {"type": "transcript", "meeting": {"platform": "google_meet", "native_id": "tys-tztv-nrj"}, "speaker": "John", "confirmed": [...], "pending": [], "ts": "2025-10-04T11:50:35.100142+00:00"}
```
